<nav class="bg-white border-gray-200 fixed top-0 left-0 w-full z-50 border-b-2 border-gray-300">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://tsoc.dev/TSoC_Favicon.svg" class="h-8" alt="TSoC Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap">Pa One</span>
        </a>
